<?php 
class Rank_checkout_model extends Model {
	function Rank_checkout_model ()
	{
		parent::Model();
	}
	...
	{
		$this->db->select(array("AREA_ID","CHECKOUTS"))
				 ->from("rank_checkout")
				 ->order_by("CHECKOUTS", "DESC");
