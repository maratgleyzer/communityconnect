<?php
error_log("attempting to save an image***************");
/**
 *
...
define ( "SAVE_PATH",  $_SERVER['DOCUMENT_ROOT']."/graphics/fusion_charts_pdfs/" );
 ...
 */
define ( "HTTP_URI", "graphics/fusion_charts_pdfs/" );
//error_log('**** sarah *****'); error_log(HTTP_URI); error_log(SAVE_PATH); error_log('**** sarah *****');
